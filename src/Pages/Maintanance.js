        ...
        <>
            <div class="card">
                <div class="card2">
                    <form class="form">
                        ...
                        <div class="note">
                            <h1 class="title mt-4 ">Site Under Construction</h1>
                            <span class="subtitle my-2"> Please forgive the inconvenience We are currently developing our site
                                <br /> Subscribe to get notified</span>
                        </div>
            ...
            <div class="social">
                <div class="social-inner">
                    <a href="https://www.instagram.com/mansoori_yasir786/" class="instagram" target="_blank">
                        <svg fill-rule="nonzero" height="25px" width="25px" viewBox="0,0,256,256"
                    ...
                    <a href="https://www.linkedin.com/in/yasir-mansoori/" class="linkedin" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                            viewBox="0 0 448 512"><path
                                d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                        </svg>
                    </a>
                    <a href="https://github.com/yasirmansoori" class="github" target="_blank">
                        <svg class="github" height="25px" width="25px" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href="https://yasirmansoori.github.io/my_portfolio/" class="portfolio" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
